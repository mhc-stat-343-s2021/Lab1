---
title: "Lab 1: Chi-squared, t, and F distributions"
...
This lab will count towards your participation score in this class. I will post solutions, but it will be helpful to you if you try to work through the lab before checking the solutions.
...
2. Get practice with the basic functions for working with random variables and creating plots using ggplot2.  Examples of this R functionality are on the first three pages of the "Common Probability Distributions" handout, also linked to on the Resources page on Moodle.
...
#### 6. At this point your data frame should have one row and 9 columns.  Verify this.  Then, go back to step 1 and change your sample size from $n = 1$ to $n = 1000$, and re-run all of your code chunks above in order.  Now instead of having one sample from a Normal(0, 1) distribution for `x1`, you'll have 1000 samples.  Verify that your data frame now has 1000 rows and 9 columns.
